...
/* ====== HTML Email Templates (styles UNCHANGED, copy neutral) ====== */

// 5) Helper: HTML Email Template for Verification (your original styles kept)
// Only the paragraph text below is toned down to neutral language.
  ...
  <body>
    <div class="container">
      ...
      <div class="content">
        ...
        <p>
          Please confirm your email address to continue. Select the button below to verify.
        </p>
...
function getVerificationEmailText(verificationLink, username) {
  return `Welcome to School Chow, ${username}!
...
// 6) Helper: HTML Email Template for Password Reset (your styles kept)
// Only the copy is neutral/safe.
  ...
  <body>
    <div class="container">
      ...
      <div class="content">
        ...
        <p>
          Use the button below to reset your password. If you didn’t request this, you can ignore this message.
        </p>
...
You requested a password reset. Open this link to continue:
${resetLink}
...
app.post('/register', async (req, res) => {
  ...
  try {
    ...
    const emailTEXT = getVerificationEmailText(verificationLink, username);
...
app.post('/vendor/register', async (req, res) => {
  ...
  try {
    ...
    const emailTEXT = getVerificationEmailText(verificationLink, firstname);
...
app.post('/forgot-password', async (req, res) => {
  ...
  try {
    ...
    const emailHTML = getPasswordResetEmailTemplate(resetLink, user.displayName || "User");
    const emailTEXT = getPasswordResetEmailText(resetLink, user.displayName || "User");
